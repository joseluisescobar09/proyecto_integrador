...
<div class="container bg-light">
    ...
    <form action="db/db_login.php" method="GET">
        ...
        <button type="reset" class="btn btn-warning btn-lg my-1 text-white font-weight-bold float-left">Limpiar</button>
        <button type="submit" class="btn btn-success btn-lg my-1 font-weight-bold float-right">Iniciar sesión</button>
        <label for="" class="col-form-label col-md-1 h1"></label></div>
