	...
	<div class="row justify-content-center">
		<div class="container-fluid">
          ...
          <h1 class="d-flex justify-content-center col-md-7 font-weight-bold font-italic">  HOMBRES + MUJERES = IGUALDAD</h1>
            ...
            <a href="log-in.php" class="float-right text-dark h4" role="button">Iniciar sesión</a>
					</ul>
...
<p class="text-danger text-md-left pt-0 mt-2 font-weight-bold">* Todos los campos son obligatorios.</p>

    <br>
      <form action="db/db_registration.php" method="GET" enctype='multipart/form-data'>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-4">
              <input type="text" name="primer_apellido" value="" id="primer_apellido" class="form-control" required>
            </div>
          </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-4">
              <input type="text" name="segundo_apellido" value="" id="segundo_apellido" class="form-control" required>
            </div>
          </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-4">
              <input type="date" id="nacimiento" name="nacimiento" value="2020-12-02" min="1960-01-01" max="2002-12-02" maxlength="3" class="form-control" required>
            </div>
          </div>
          ...
          <div class="row form-group">
           ...
           <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="genero" id="genero" value="H" required>
              <label class="form-check-label" for="hombre">Masculino</label>
            </div>
            <label for=" " class="col-form-label col-xs-4 "></label>
            <div class="form-check form-check-inline">
          ...
          <div class="row form-group">
            ...
            id="email" name="email" aria-describedby="emailHelp" placeholder="example@domain.com" required>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-9">
              <div class="form-group form-check">
                ...
                <label class="form-check-label" for="exampleCheck1">He leído y aceptado los <a href="../docs/terms.pdf" target="_blank">terminos y condiciones.</a></label>
              </div> 
            </div>
          </div>
          ...
          <div class="row form-group font-italic">
            <label for="" class="col-form-label col-md-4 h1"></label>
            <p for="exampleInputPassword1" class="col-form-label col-md-2 h3">¿Ya tienes cuenta?  </p> 
            <a class="text-info font-weight-bold h4" href="log-in.php">Inicia sesión</a>
  
          </div><br>        <label for="" class="col-form-label col-md-8 h1"></label>
        <button type="reset" class="btn btn-warning btn-lg float-left text-white font-weight-bold">Comenzar de nuevo</button>
        <button type="submit" class="btn btn-success btn-lg float-right font-weight-bold " name="register" value="register">Registrarse</button>
        <label for="" class="col-form-label col-md-1 h1"></label> <br> <br></div>
