...
<div class="container bg-white">
    ...
    <div class="container bg-light">
      <div class="alert alert-success text-center" role="alert">
        Cuenta eliminada exitosamente, registrate de nuevo. 
     </div><br>
     <p class="text-danger text-md-left pt-0 mt-2 font-weight-bold">* Todos los campos son obligatorios.</p> <br>
      <form action="db/db_registration.php" method="GET" enctype='multipart/form-data'>
        ...
        <button type="submit" class="btn btn-success btn-lg my-1 float-right font-weight-bold " name="register" value="register">Registrarse</button>
        <label for="" class="col-form-label col-md-1 h1"></label>
  <script>
