...
<div class="container bg-light">
    <div class="alert alert-danger text-center" role="alert">
        Dirección de correo no válida, intente de nuevo. 
    </div><br>
    <form action="db/db_login.php" method="GET">
          ...
          <div class="row form-group font-italic">
            ...
            <p for="exampleInputPassword1" class="col-form-label col-md-3 h3">¿Aún no te has registrado?  </p> 
            <a class="text-info font-weight-bold h4" href="sign-up.php">Registrate</a>
  
          </div><br>

        <label for="" class="col-form-label col-md-9 h1"></label>
        <button type="reset" class="btn btn-warning btn-lg my-1 float-center">Limpiar</button>
        <button type="submit" class="btn btn-success btn-lg my-1 float-right">Iniciar sesión</button>
