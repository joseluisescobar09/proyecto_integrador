...
<div class="container bg-white">
     ...
     <div class="comtainer">
     <div class="col-md-12 ">
      <img src="/images/niña.png" class="rounded-circle"  align="left" width="35%"  >
      <h1 class=" display-4 font-weight-bold font-italic" align="left">¿Por qué es importante la Igualdad de Género?</h1>
      <br>
      <br>
      <br>
      <br>
      <br>
      <br>
      <p class="h4 pb-0 mb-0" class="bg-danger" class="text-nowrap">La igualdad de género es esencial para lograr la Agenda 2030 para el desarrollo sostenible, que contempla un mundo de “respeto universal por los derechos humanos y la dignidad humana” y un mundo en el que “todas las mujeres y niñas gocen de la plena igualdad de género, y donde se hayan eliminado todos los obstáculos jurídicos, sociales y económicos que impiden su empoderamiento”. La Agenda 2030 reivindica la igualdad de género no solo como un derecho humano fundamental, sino como una base necesaria para lograr un mundo pacífico, próspero y sostenible.
      </p> <br>
      <br>
      <br>

    <p class="h6 pb-0 mb-0" class="text-nowrap" > <strong> Para más detalles visita la página: <a href="https://www.tercerainformacion.es/articulo/internacional/28/02/2017/por-que-es-importante-la-igualdad-de-genero/" target="_blank" </strong>>https:/por-que-es-importante-la-igualdad-de-genero/
     </p> <br>
