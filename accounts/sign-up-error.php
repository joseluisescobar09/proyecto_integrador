...
<div class="container bg-white">
    ...
    <div class="container bg-light"> <br>
      <div class="alert alert-danger text-center" role="alert">
        El correo que ingresaste ya existe, intenta con otra dirección. 
     </div><br>
     <p class="text-danger text-md-left pt-0 mt-2 font-weight-bold">* Todos los campos son obligatorios.</p> <br>
      <form action="db/db_registration.php" method="GET" enctype='multipart/form-data'>
          ...
          <div class="row form-group">
            ...
            <small id="emailHelp" class="form-text font-weight-bold text-danger">* Ingresa una dirección válida.</small>
            </div>
          </div>
        ...
        <label for="" class="col-form-label col-md-8 h1"></label>
