...
<div class="container bg-light">
        ...
        <form action="db/db_delete.php" method="GET">
          <br>
          <?php include 'db/db_profile_delete.php'; ?> <br>

        <label for="" class="col-form-label col-md-4 h1"></label>
        <button type="submit" class="btn btn-danger btn-lg  float-center">Confirmar</button>
        <label for="" class="col-form-label col-md-1 h1"></label>
        <a href="my-profile.php" class="btn btn-primary btn-lg float-center">Cancelar</a> <br> <br>
        
    <div class="alert alert-warning text-center" role="alert">
        Si la eliminas puedes volver a crear otra más tarde. 
    </div>
        </form>
