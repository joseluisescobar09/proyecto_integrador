...
<div class="container bg-white">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light ">
        ...
        <a class="navbar-brand h4 mr-5 text-info" href="../check/test.html">Evaluate</a>
...
<div class="alert alert-danger text-center" role="alert">
  Lo sentimos, el correo que ingresaste ya está asignado en otra cuenta, intenta con otra diferente.
</div>
<p class="text-danger text-md-left pt-0 mt-2 font-weight-bold">* Puedes actualizar tus credenciales de inicio de sesión (correo y contraseña).</p>
    ...
    <br>
      <form action="../db/db_update_profile.php" method="GET" enctype='multipart/form-data'>
		 ...
		 <?php include '../db/db_profile_update.php'; ?> <br>

        <button type="reset" class="btn btn-danger btn-lg  float-right text-white font-weight-bold">Eliminar cuenta</button>
