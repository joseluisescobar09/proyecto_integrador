	...
	<div class="row justify-content-center">
		<div class="container-fluid">
          ...
          <h1 class="d-flex justify-content-center col-md-7 font-weight-bold font-italic">  HOMBRES + MUJERES = IGUALDAD</h1>
            ...
            <a href="../accounts/log-in.php" class="float-right text-dark h5" role="button">Iniciar sesión</a>
					</ul>
					<ul class="col-form-label mb-0">
						<a class="dropdown  float-right text-dark h5" href="../accounts/sign-up.php" role="button">Registrate</a>
					</ul>
				</nav>
		</div>
	</div>
...
<div class="container bg-white">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light ">
        ...
        <a class="navbar-brand h4 mr-5 text-info" href="test.html">Evaluate</a>
